...
class StaffSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('staffs')->insert([
            ...
            //     'status' => 'active',
            //     'location' => 'Location 1',
            //     'password' => Hash::make('LoginPass1223456'), // You can use any default password here
            ...
            [
                'admin_id' => 1,
                'name' => 'Mariam Peter',
                'email' => 'barakaurio0@gmail.com',
                'phone' => '255876543210',
                'role' => 'staff',
                'status' => 'active',
                'location' => 'Location 2',
                'password' => Hash::make('LoginPass123'), // You can use any default password here
                // Add other fields as needed
                'created_at' => now(),
                'updated_at' => now(),
            ],
