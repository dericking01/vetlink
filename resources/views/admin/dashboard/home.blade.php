            ...
            <div class="card-header position-relative">
              ...
              <div class="position-relative z-2">
                ...
                <div class="d-flex py-3 px-2">
                  ...
                  <div class="ps-4">
                    <p class="text-600 fs--1">Today’s marketplace sales </p>
                    <h4 class="text-800 mb-0">$21,349.29 </h4>
                  </div>
                </div>
              </div>
            ...
            <div class="card-body">
              <div class="row flex-between-center g-0">
                <div class="col-6 d-lg-block flex-between-center">
                  <h6 class="mb-2 text-900">Total Buyers</h6>
        ...
        <div class="col-md-4">
          <div class="card h-100">
            <div class="card-body">
              <div class="row flex-between-center g-0">
                <div class="col-6 d-lg-block flex-between-center">
                  <h6 class="mb-2 text-900">Total Sellers</h6>
                  <h4 class="fs-3 fw-normal text-700 mb-0">765k</h4>
                  <a href="#">View all</a>
                </div>
                <div class="col-auto h-100">
        ...
        <div class="col-md-4">
          <div class="card h-100">
            <div class="card-body">
              <div class="row flex-between-center g-0">
                <div class="col-6 d-lg-block flex-between-center">
                  <h6 class="mb-2 text-900">Total Agents</h6>
                  <h4 class="fs-3 fw-normal text-700 mb-0">765k</h4>
                  <a href="#">View all</a>
                </div>
                <div class="col-auto h-100">
    ...
    <div class="col-xxl-6 col-xl-12">
      <div class="card py-3 mb-3">
        <div class="card-body py-3">
          <h5 class="mb-2 text-primary">SAB Orders</h5>
          <div class="row g-0">
            ...
            <div class="col-6 col-md-4 border-200 border-bottom border-end border-end-md-0 pb-4 pt-4 pt-md-0 ps-md-3">
              ...
              <p class="font-sans-serif lh-1 mb-1 fs-2">Tsh 345,000/= </p>
              <div class="d-flex align-items-center">
            ...
            <div class="col-6 col-md-4 border-200 border-bottom border-bottom-md-0 border-end-md pt-4 pb-md-0 ps-3 ps-md-0">
              ...
              <div class="d-flex align-items-center">
                <h6 class="fs--1 text-500 mb-0">109 </h6>
            ...
            <div class="col-6 col-md-4 border-200 border-bottom-md-0 border-end pt-4 pb-md-0 ps-md-3">
              ...
              <p class="font-sans-serif lh-1 mb-1 fs-2">365 </p>
              <div class="d-flex align-items-center">
                <h6 class="fs--1 text-500 mb-0">345 </h6>
                <h6 class="fs--2 ps-3 mb-0 text-success"><span class="me-1 fas fa-caret-up"></span>21.8%</h6>
              </div>
            </div>
            <div class="col-6 col-md-4 pb-0 pt-4 ps-3">
              ...
              <div class="d-flex align-items-center">
                <h6 class="fs--1 text-500 mb-0">175 </h6>
      ...
      <div class="card py-3 mb-3">
        <div class="card-body py-3">
          <h5 class="mb-2 text-primary">MarketPlace Orders</h5>
          <div class="row g-0">
            <div class="col-6 col-md-4 border-200 border-bottom border-end pb-4">
              <h6 class="pb-1 text-700">Orders </h6>
              <p class="font-sans-serif lh-1 mb-1 fs-2">15,450 </p>
            ...
            <table class="table table-sm fs--1 mb-0 overflow-hidden">
              ...
              <tbody class="list" id="table-purchase-body">
                <tr class="btn-reveal-trigger">
                  ...
                  <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-success">Success<span class="ms-1 fas fa-check" data-fa-transform="shrink-2"></span></span></td>
                ...
                <tr class="btn-reveal-trigger">
                  ...
                  <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-secondary">Blocked<span class="ms-1 fas fa-ban" data-fa-transform="shrink-2"></span></span></td>
                ...
                <tr class="btn-reveal-trigger">
                  ...
                  <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-subtle-warning">Pending<span class="ms-1 fas fa-stream" data-fa-transform="shrink-2"></span></span></td>
          ...
          <div class="table-responsive scrollbar">
            <table class="table table-dashboard mb-0 table-borderless fs--1 border-200">
              ...
              <tbody>
                ...
                <tr class="border-bottom border-200">
                  <td>
                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{ asset('/') }}assets/img/ecommerce/2.jpg" width="60" alt="" />
                      <div class="flex-1 ms-3">
                ...
                <tr class="border-bottom border-200">
                  <td>
                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{ asset('/') }}assets/img/ecommerce/3.jpg" width="60" alt="" />
                      <div class="flex-1 ms-3">
                ...
                <tr class="border-bottom border-200">
                  <td>
                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{ asset('/') }}assets/img/ecommerce/4.jpg" width="60" alt="" />
                      <div class="flex-1 ms-3">
                ...
                <tr class="border-bottom border-200">
                  <td>
                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{ asset('/') }}assets/img/ecommerce/5.jpg" width="60" alt="" />
                      <div class="flex-1 ms-3">
                ...
                <tr class="border-bottom border-200">
                  <td>
                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{ asset('/') }}assets/img/ecommerce/6.jpg" width="60" alt="" />
                      <div class="flex-1 ms-3">
                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center position-relative"><img class="rounded-1 border border-200" src="{{ asset('/') }}assets/img/ecommerce/7.jpg" width="60" alt="" />
                      <div class="flex-1 ms-3">
