    ...
    <div class="row align-items-center">
        ...
        <div class="col text-end">
            <a class="font-sans-serif" href="#!" data-bs-toggle="modal" data-bs-target="#addproductcat">
                <button class="btn btn-falcon-default btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#addBranch" >
                    <svg class="svg-inline--fa fa-plus fa-w-14" data-fa-transform="shrink-3 down-2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="" style="transform-origin: 0.4375em 0.625em;"><g transform="translate(224 256)"><g transform="translate(0, 64)  scale(0.8125, 0.8125)  rotate(0 0 0)"><path fill="currentColor" d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z" transform="translate(-224 -256)"></path></g></g></svg><!-- <span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span> Font Awesome fontawesome.com -->
                        <span class="d-none d-sm-inline-block ms-1">Add Branch</span>
                </button>
        ...
        <table class="table data-table table-bordered table-striped fs--1 mb-0">
          ...
          <tbody class="list">
            @foreach($branches as $key => $branch)
              ...
              <div class="modal fade" id="deleteBranch{{ $branch->id }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('branch.destroybranch') }}" method="POST">
                            @csrf
                            @method('DELETE')
              ...
              {{-- edit modal here --}}
              <div class="modal fade" id="editBranch{{ $branch->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                          ...
                          <div class="modal-content position-relative">
                            ...
                            <div class="modal-body p-0">
                                <div class="rounded-top-3 py-3 ps-4 pe-6 bg-light">
                                    <h4 class="mb-1" id="modalExampleDemoLabel">Edit Branch </h4>
                                </div>
                                ...
                                <div class="p-4 pb-0">
                                  <div class="row">
                                      <div class="col-md-12">
                                          <div class="mb-3">
                                            <label for="validationCustom03" class="form-label">Branch Name</label>
                                            <input class="form-control @error('name') is-invalid @enderror" id="validationCustom03" value="{{ old('name', $branch->branch_name) }}" name="name" type="text" autocomplete="on" placeholder="Branch Name"/>
                                            @error('name')
                                      ...
                                      <div class="col-md-12">
                                        {{-- <div class="mb-3">
                                          ...
                                          <input class="form-control @error('phone') is-invalid @enderror" id="validationCustom04" value="{{ old('phone', $branch->phone) }}" type="phone" name="phone" autocomplete="on" placeholder="Phone number"/>
                                          @error('phone')
                                              <div class="invalid-feedback">{{ $message }}</div>
                                          @enderror
                                        </div> --}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                          ...
                                          <input class="form-control @error('location') is-invalid @enderror" id="validationCustom03" value="{{ old('name', $branch->location) }}" name="location" type="text" autocomplete="on" placeholder="location"/>
                                          @error('location')
                                              <div class="invalid-feedback">{{ $message }}</div>
                                          @enderror
                                        </div>
...
<div class="modal fade" id="addBranch" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form action="{{ route('admin.storebranch') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="novalidate">
            @csrf
            <div class="modal-content position-relative">
                <div class="position-absolute top-0 end-0 mt-2 me-2 z-1">
                    <button class="btn-close btn btn-sm btn-circle d-flex flex-center transition-base"
                ...
                <div class="modal-body p-0">
                    <div class="rounded-top-3 py-3 ps-4 pe-6 bg-light">
                        <h4 class="mb-1" id="modalExampleDemoLabel">Add Branch </h4>
                    </div>
                    <div class="p-4 pb-0">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                  <label for="validationCustom03" class="form-label">Branch Name</label>
                                  <input class="form-control @error('name') is-invalid @enderror" id="validationCustom03" value="{{ old('name') }}" name="name" type="text" autocomplete="on" placeholder="Branch Name" required />
                                  @error('name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                  @enderror
                                </div>
                          ...
                          <div class="col-md-12">
                            <div class="mb-3">
                              ...
                              <input class="form-control @error('location') is-invalid @enderror" id="validationCustom05" value="{{ old('location') }}" type="text" name="location" autocomplete="on" placeholder="Branch's Location" required />
                              @error('location')
                                <div class="invalid-feedback">{{ $message }}</div>
                              @enderror
                            </div>
