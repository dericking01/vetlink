...
<div class="card">
    <div class="card-header bg-light">
      <div class="row align-items-center">
          <div class="col">
              <h5 class="mb-0" id="followers">Overdue Invoices
                ...
                <td class="align-middle white-space-nowrap text-end">
                  <div class="dropstart font-sans-serif position-static d-inline-block">
                      ...
                      <div class="dropdown-menu dropdown-menu-end border py-2"
                        ...
                        <a class="dropdown-item text-danger" href="#!" data-bs-toggle="modal" data-bs-target="#deleteOverdueInvoice{{ $invoice->id }}">Delete</a>
                      </div>
                    </div>
                </td>
              </tr>

              {{-- Delete Overdue Invoice Modal --}}
              <div class="modal fade" id="deleteOverdueInvoice{{ $invoice->id }}" tabindex="-1" aria-hidden="true">
