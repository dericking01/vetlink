      ...
      <div class="row gx-5">
        ...
        <main class="col-lg-6">
          <div class="ps-lg-3">
            ...
            @if($product->status)
                <a href="#" class="btn btn-success shadow-0"> <i class="me-1 fa fa-check-circle"></i> Active</a>
            @else
                <a href="#" class="btn btn-danger shadow-0"><i class="me-1 fa fa-times-circle"></i> Inactive</a>
            @endif
