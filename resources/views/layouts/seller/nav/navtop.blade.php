<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand" style="display: none;">
    ...
    <a class="navbar-brand me-1 me-sm-3" href="index.html">
        <div class="d-flex align-items-center"><img class="me-2"
                src="{{ asset('/') }}assets/img/icons/spot-illustrations/sab.png" alt=""
                width="40" /><span class="font-sans-serif"></span></div>
    </a>
    <ul class="navbar-nav align-items-center d-none d-lg-block">
        <li class="nav-item">
            @include('layouts.seller.nav.partials.search-box')
        </li>
    </ul>
            ...
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                ...
                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    <a class="dropdown-item fw-bold text-warning" href="#!"><span
                            class="fas fa-crow me-1"></span><span>{{auth('seller')->user()->name}}</span></a>
...
<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-lg" style="display: none;"
    ...
    <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
        <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
            @include('layouts.seller.nav.partials.navbarStandard')
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        ...
        <li class="nav-item dropdown px-1">
            ...
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end dropdown-menu-card dropdown-caret-bg"
                ...
                @include('layouts.seller.nav.partials.navbarDropdownMenu')
            </div>
        </li>
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser"
                role="button" data-bs-toggle="dropdown" aria-haspopup="true"
            ...
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                aria-labelledby="navbarDropdownUser">
            @include('layouts.seller.nav.partials.navbarDropdownUser')   
            </div>
        </li>
    </ul>
</nav>
