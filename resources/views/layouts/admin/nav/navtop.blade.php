    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        ...
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser"
                ...
                <div class="avatar avatar-xl">
                    {{-- <span>{{ \App\Helpers\SettingsHelper::getAdminInitials($admin->id) }}</span> --}}
...
<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand-lg" style="display: none;"
    ...
    <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
        <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
            @include('layouts.admin.nav.partials.navbarStandard')
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        ...
        <li class="nav-item dropdown px-1">
            ...
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end dropdown-menu-card dropdown-caret-bg"
                ...
                @include('layouts.admin.nav.partials.navbarDropdownMenu')
            </div>
        </li>
        <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser"
                role="button" data-bs-toggle="dropdown" aria-haspopup="true"
            ...
            <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
                aria-labelledby="navbarDropdownUser">
            @include('layouts.admin.nav.partials.navbarDropdownUser')
            </div>
        </li>
    </ul>
</nav>
