...
<div class="card">
    ...
    <div class="card-header bg-light">
      <div class="row align-items-center">
          <div class="col">
              <h5 class="mb-0" id="followers">My Products
          ...
          <table class="table data-table table-bordered table-striped fs--1 mb-0">
            ...
            <tbody class="list">
              ...
              <tr>
                ...
                @else
                <td class="SoldOut">
                  <span class="badge badge-subtle-danger">SOLD OUT</span>
                </td>
                @endif
              ...
              <div class="modal fade" id="deleteSender{{ $product->id }}" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 500px">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('seller.destroy') }}" method="POST">
                            @csrf
                            @method('DELETE')
              ...
              <div class="modal fade" id="editSender{{ $product->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <form action="{{ route('seller.updateProducts', ['id' => $product->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control select2"
                                                  ...
                                                  <option value="{{ $product->name }}" {{ (old('name', $product->name) == $product->name) ? 'selected' : '' }}>{{ $product->name }}</option>
                                                  @endforeach
                                                </select>
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-md-6">
                                          <div class="mb-3">
                                              ...
                                              <select class="form-control select2"
                                                  ...
                                                  <option value="{{ $productCategory->id }}" {{ (old('product_category_id', $product->product_category_id) == $productCategory->id) ? 'selected' : '' }}>{{ $productCategory->CatName }}</option>
                                                  @endforeach
                                              </select>
                                          </div>
                                      </div>
  ...
  <div class="modal fade" id="addproduct" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <form action="{{ route('seller.storeProducts') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate="novalidate">
            @csrf
            <div class="modal-content position-relative">
                <div class="position-absolute top-0 end-0 mt-2 me-2 z-1">
                    <button class="btn-close btn btn-sm btn-circle d-flex flex-center transition-base"
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="p-4 pb-0">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="status">Product Name <span class="text-danger">*</span> </label>
