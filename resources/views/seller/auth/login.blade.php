    ...
    <div class="col-sm-10 col-md-6 px-sm-0 align-self-center mx-auto py-5">
      <div class="row justify-content-center g-0">
        <div class="col-lg-9 col-xl-8 col-xxl-6">
          <div class="card">
            <div class="card-header bg-circle-shape bg-shape text-center p-2"><a class="font-sans-serif fw-bolder fs-4 z-1 position-relative link-light" href="#!" data-bs-theme="light">SAB SELLER'S PORTAL</a></div>
            <div class="card-body p-4">
              <div class="row flex-between-center">
                ...
                <div class="col-auto fs--1 text-600">
                    <span class="mb-0 fw-semi-bold">Not Seller?</span> 
                    <span><a href="#!">Go Here</a></span>
                </div>
              </div>
              <form action="{{ route('seller.submit.login') }}" method="POST">
                @csrf
                <div class="mb-3">
