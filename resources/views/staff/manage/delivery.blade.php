@extends('layouts.staff.deliverybase')
...
<div class="card">
  <div class="card-header bg-light">
    <div class="row align-items-center">
        <div class="col">
            <h5 class="mb-0" id="followers">Delivery Orders
          ...
          <tbody class="list">
            ...
            <div class="modal fade" id="editPendingOrder{{ $order->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <form action="{{ route('staff.deliverystatus.update', ['id' => $order->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="p-4 pb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control select2" id="status" name="branch" disabled>
